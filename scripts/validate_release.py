...
EVIDENCE_DIR = ROOT / "docs" / "release" / "evidence" / "release"
REPORT_PATH = EVIDENCE_DIR / "release_validation_report.json"

REQUIRED = [
    "clean_install.json",
    "clean_boot.json",
    "enterprise_gate_blocks_invalid_release.json",
    "rollback_recovery.json",
    "evidence_bundle_integrity.json",
]
