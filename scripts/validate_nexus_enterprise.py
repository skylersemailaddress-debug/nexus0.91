...
def validate_adaptive_learning_gate() -> CheckResult:
    return _validate_report_gate("adaptive_learning_gate", ADAPTIVE_LEARNING_REPORT_PATH, "adaptive_learning")


def validate_max_power_gate() -> CheckResult:
